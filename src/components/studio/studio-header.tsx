    ...
    <header className="studio-header-band studio-header-band--compact relative z-20 shrink-0">
      <div className="studio-stage">
        <div className="studio-stage__grid py-2">
          <h1 className="studio-hero-title studio-hero-title--compact studio-stage__apps">
            Lifecycle <span className="studio-hero-gradient">Architecture</span> Stack
          </h1>
          <div className="studio-badge studio-stage__stack hidden sm:inline-flex">Interactive Blueprint</div>
        </div>
      </div>
    </header>
  );
    ...
    <div className="relative z-20 shrink-0 border-b border-[rgba(255,255,255,0.05)]">
      <div className="studio-stage">
        <div className="studio-stage__grid py-1.5">
          <div className="studio-stage__apps flex flex-wrap gap-1.5">
          ...
          <button
            ...
            className="studio-btn-pill studio-btn-pill--compact studio-stage__stack"
          >
